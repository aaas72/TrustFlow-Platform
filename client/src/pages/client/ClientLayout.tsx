...
export default function ClientLayout() {
  ...
  const [userName, setUserName] = useState<string>("Müşteri");
  ...
  useEffect(() => {
    ...
    setUserName(user?.fullName || "Müşteri");
  }, []);
  ...
  const menuItems = useMemo(
    () => [
      ...
      { key: "create", label: "Yeni Proje", icon: <FiPlusCircle /> },
      { key: "projects", label: "Projelerim", icon: <FiFolder /> },
